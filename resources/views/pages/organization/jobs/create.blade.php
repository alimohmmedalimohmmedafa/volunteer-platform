...
<div class="mb-4">
    <h1 class="fw-bold mb-1">إضافة فرصة تطوع</h1>
    <p class="text-muted mb-0">أنشئ فرصة تطوع جديدة لمنظمتك.</p>
</div>
...
<form method="POST" action="{{ route('organization.jobs.store') }}" novalidate>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" rows="5"
                              ...
                              placeholder="اكتب وصفًا واضحًا للفرصة وطبيعة المهام المتوقعة..."
                ...
                <div class="col-12">
                    ...
                    <textarea name="requirements" id="requirements" rows="5"
                              ...
                              placeholder="اكتب متطلبات المشاركة في الفرصة (مثال: مهارات، مؤهلات)...">{{ old('requirements') }}</textarea>
                    <small class="text-muted">
                        <i class="bi bi-info-circle me-1" aria-hidden="true"></i>
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <a href="{{ route('organization.jobs.index') }}" class="btn btn-outline-secondary">
            إلغاء
        </a>
    </div>
